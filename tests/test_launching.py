...
def test_desktop_app_returns_none_for_unknown_ids():
    from launcher.launching import desktop_app

    assert desktop_app("definitely-not-installed-xyz.desktop") is None
